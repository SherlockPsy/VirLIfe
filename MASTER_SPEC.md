...
This clarification resolves any apparent mismatch between the core list in §1.3  
and the extended kernel definition in PART IIA. There is no contradiction.
